...
def load_hifigan_vocoder(language, gender, device):
    ...
    vocoder_config = f"cp-hifi-tamil/config_eng.json"
    vocoder_generator = f"cp-hifi-tamil/cp_hifigan_00245000"
...
def load_fastspeech2_model(language, gender, device):
    ...
    feat="exp/tts_stats_raw_char_None/train/feats_stats.npz"
    pitch="exp/tts_stats_raw_char_None/train/pitch_stats.npz"
    energy="exp/tts_stats_raw_char_None/train/energy_stats.npz"
    ...
    tts_model = f"exp/tts_train_fastspeech2_raw_char_None/1000epoch.pth"
    tts_config = f"exp/tts_train_fastspeech2_raw_char_None/config.yaml"
...
if __name__ == "__main__":
    ...
    with concurrent.futures.ThreadPoolExecutor() as executor:
        ...
        for sample_text in result:
            ...
            # Preprocess the text and obtain a list of phrases (command these lines and use sample_text directly for character based one)
            ...
            audio = text_synthesis(args.language, args.gender,sample_text, vocoder, MAX_WAV_VALUE, device, args.alpha)
